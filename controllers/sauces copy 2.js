...
exports.likeThing = (req, res, next) => {
    ...
    //Vérifier si l'utilisateur a liker ou Disliker
    //
            ...
            Thing.findOneAndUpdate({
                ...
                .then(
                    () => {
                        ...
                        //Icic je recupere les info de la premiere fonction
                        //If userid à déja dans l'array
                        // alors, j'update
        ...
        case -1:
            Thing.findOne({
                ...
                (thing) => {
                    console.log("findone")
                    res.status(200).json({
                        message: 'Thing finded successfully!'
});
                }
            ).catch(
                (error) => {
